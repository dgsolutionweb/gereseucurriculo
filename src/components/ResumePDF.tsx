...
export default function ResumePDF({ data }: ResumePDFProps) {
  return (
    <div className="w-full md:w-[210mm] min-h-[297mm] bg-white flex flex-col md:flex-row print:w-[210mm] print:flex-row">
      {/* Barra Lateral */}
      <div className="w-full md:w-[85mm] bg-[#1E2532] p-4 md:p-8 text-white print:w-[85mm] print:p-8">
        {/* Foto e Contato */}
          ...
          <div className="space-y-2 md:space-y-3">
            {data.skills.map((skill, index) => (
              <div key={index} className="flex flex-col gap-1">
                <div className="flex justify-between text-xs md:text-sm text-gray-300 print:text-gray-200">
                  <span>{skill}</span>
                </div>
      ...
      {/* Conteúdo Principal */}
      <div className="flex-1 p-4 md:p-8 print:p-8">
        {/* Cabeçalho */}
        <div className="mb-6 md:mb-8">
